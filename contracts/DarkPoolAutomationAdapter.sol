...
///      so implementations MUST return true for type(IReceiver).interfaceId.
...
contract DarkPoolAutomationAdapter is IReceiver {
    ...
    function onReport(bytes calldata /* metadata */, bytes calldata report) external override {
        ...
        // KeystoneForwarder (production) and MockForwarder (simulation) both
        // call this function after validating the DON signature.
